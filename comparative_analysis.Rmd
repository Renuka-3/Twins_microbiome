...
theme(text = element_text(size = 10)) + labs(x = "", y= "Bray-Curtis index", title = " Twin pair comparison") + scale_x_discrete(labels=c("within_pairs" = "Twins", "between_pairs" = "Non-twins")) + theme_bw(base_size = 20)
print(a1)
