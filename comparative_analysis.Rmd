...
geom_jitter(aes(colour = City), width= 0.05, size= 1.7) +
geom_signif(comparisons = list(c("within_pairs", "between_pairs")), map_signif_level = FALSE) +
theme(text = element_text(size = 10)) + labs(x = "", y= "Bray-Curtis index", title = "B") + scale_x_discrete(labels=c("within_pairs" = "Twins", "between_pairs" = "Non-twins")) + theme_bw() + theme(text = element_text(size = 23), axis.text = element_text(size = 23), axis.title = element_text(size = 18))
print(a2)
library(gridExtra)
